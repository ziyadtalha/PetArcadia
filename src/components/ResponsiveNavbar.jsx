    ...
    <AppBar position="static" sx={{backgroundColor: theme.palette.background.default, boxShadow:'none'}}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{display: 'flex', justifyContent:"end", flex: 1}} mr={isLargeScreen ? 10 : 4} maxWidth="xl">
            ...
            <Box sx={{ flexGrow: 0, display: { xs: 'none', md: 'flex' }}}>
              {pages.map((page) => (
                <Button
                  ...
                  sx={{boxShadow:'none', color:"#5C5C5C", width: "auto", mx:2}}
                >
                  <Typography variant='h5' fontSize={"1.1rem"}>{page}</Typography>
                </Button>
              ))}
            </Box>
          </Box>
